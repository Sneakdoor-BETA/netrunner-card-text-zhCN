# netrunner-card-text-zhCN

*矩阵潜袭卡牌中文文本数据仓库*

## 仓库简介

这里存放矩阵潜袭所有卡牌的中文文本，以CSV/JSON格式存储。中文卡牌文本数据以 [在线表格](https://docs.google.com/spreadsheets/d/1TlF9ZKJ1W6LFSSYSM6WleowZ316o90eNM48pd-da_ao/) 的形式维护以方便更新及勘误。本仓库用于在Google Docs表格更新后通过Git Action将这些更改同步到本仓库的CSV/JSON文件。
